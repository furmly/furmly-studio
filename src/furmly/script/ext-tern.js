    ...
    function(require, exports, module) {
      ...
      (function() {
        ...
        this.insertSnippetForSelection = function(editor, snippetText) {
          ...
          tokens.forEach(function(p, i) {
            ...
            if (isNested && !ts.value) {
              ...
              value.length &&
              (!ts.value || typeof ts.value !== "string")
            ) {
              ts.value = value.join("");
            }
          });
          ...
          tokens.forEach(function(t) {
            if (typeof t === "string") {
              ...
              if (!t.start) t.start = { row: row, column: column };
              else t.end = { row: row, column: column };
            }
          });
        ...
        this.expandWithTab = function(editor, options) {
          var self = this;
          var result = editor.forEachSelection(
            function() {
      ...
      var TabstopManager = function(editor) {
        ...
        this.$onChangeSelection = lang.delayedCall(
      ...
      (function() {
        ...
        this.onChange = function(delta) {
          ...
          if (!this.$inChange && isRemove) {
            ...
            var changedOutside =
              ...
              !ts.some(function(r) {
                return (
                  comparePoints(r.start, start) <= 0 &&
                  comparePoints(r.end, end) >= 0
                );
              });
          ...
          for (var i = 0; i < ranges.length; i++) {
            ...
            if (
              isRemove &&
              comparePoints(start, r.start) < 0 &&
              comparePoints(end, r.end) > 0
            ) {
              this.removeRange(r);
              i--;
              continue;
        ...
        this.onChangeSelection = function() {
          ...
          for (var i = this.ranges.length; i--; ) {
            ...
            var containsAnchor =
              isEmpty || this.ranges[i].contains(anchor.row, anchor.column);
        ...
        this.addTabstopMarkers = function(ts) {
          ...
          ts.forEach(function(range) {
            if (!range.markerId)
              range.markerId = session.addMarker(
                range,
                "ace_snippet-marker",
                "text"
              );
        ...
        this.keyboardHandler.bindKeys({
          Tab: function(ed) {
            if (
              exports.snippetManager &&
              exports.snippetManager.expandWithTab(ed)
            ) {
              return;
            }
  ...
  ace.define(
    ...
    function(require, exports, module) {
      ...
      var AcePopup = function(parentNode) {
        ...
        selectionMarker.id = popup.session.addMarker(
          selectionMarker,
          "ace_active-line",
          "fullLine"
        );
        popup.setSelectOnHover = function(val) {
          if (!val) {
            hoverMarker.id = popup.session.addMarker(
              hoverMarker,
              "ace_line-hover",
              "fullLine"
            );
        ...
        bgTokenizer.$tokenizeRow = function(row) {
          ...
          if (data.iconClass)
            //show icon in popup if specified by completor
            tokens.push({
              type: data.iconClass,
              value: " "
            });
          ...
          if (data.meta) {
            var maxW =
              popup.renderer.$size.scrollerWidth /
              popup.renderer.layerConfig.characterWidth;
            var metaData = data.meta;
            if (metaData.length + data.caption.length > maxW - 2) {
              metaData =
                metaData.substr(0, maxW - data.caption.length - 3) + "\u2026";
            }
  ...
  ace.define(
    ...
    function(require, exports, module) {
      ...
      var Autocomplete = function() {
        ...
        this.tooltipTimer = lang.delayedCall(
      ...
      (function() {
        ...
        this.updateCompletions = function(keepPopupPosition) {
          ...
          this.gatherCompletions(
            ...
            function(err, results) {
              ...
              if (
                prefix.indexOf(results.prefix) !== 0 ||
        ...
        this.updateDocTooltip = function() {
          ...
          var all = popup.data;
          var selected =
            all && (all[popup.getHoveredRow()] || all[popup.getRow()]);
          var doc = null;
      ...
      (function() {
        this.setFilter = function(str) {
          if (
            str.length > this.filterText &&
            str.lastIndexOf(this.filterText, 0) === 0
          )
  ...
  function(require, exports, module) {
    ...
    var TernServer = function(options) {
      ...
      if (!this.options.hasOwnProperty("switchToDoc"))
        this.options.switchToDoc = function(name, start) {
          console.log(
            "tern.switchToDoc called but not defined (need to specify this in options to enable jumpting between documents). name=" +
              name +
              "; start=",
            start
          );
      ...
      if (!this.options.hasOwnProperty("defs"))
        this.options.defs = [/*'jquery',*/ "browser", "ecma5"];
      ...
      ternRefresh: {
        ...
        exec: function(editor) {
          ...
          if (editor.ternServer.refreshDocLastCalled != null) {
            if (
              new Date().getTime() - editor.ternServer.refreshDocLastCalled <
              1000
            ) {
              //less than 1 second
              full = true;
    ...
    TernServer.prototype = {
      ...
      refreshDoc: function(editor, full) {
        ...
        sendDoc(this, doc);
        showTip(
          "Tern document refreshed <div style=\"color:gray; font-size:smaller;\">(press hotkey twice in  &lt; 1 second to do a full reload including refs)</div>"
        );
      },
    ...
    function buildRequest(ts, doc, query, pos, forcePushChangedfile) {
      ...
      if (doc.changed) {
        if (
          ...
          doc.doc.session.getLength() > bigDoc &&
    ...
    function getFragmentAround(data, start, end) {
      ...
      if (
        minIndent == null ||
        minIndent ==
          countColumn(editor.session.getLine(start.line), null, tabSize)
      )
        endLine = max;
      else
        for (endLine = end.line + 1; endLine < max; ++endLine) {
          var indent = countColumn(
            editor.session.getLine(endLine),
            null,
            tabSize
          );
    ...
    function getCompletions(ts, editor, session, pos, prefix, callback) {
      ...
      if (!forceEnableAceTextCompletor) {
        ...
        if (t && t.type && t.type.indexOf("comment") !== -1)
          forceEnableAceTextCompletor = true;
      }
      ...
      ts.request(
        ...
        function(error, data) {
          ...
          var ternCompletions = data.completions.map(function(item) {
            return {
              iconClass:
                " " + (item.guess ? cls + "guess" : typeToIcon(item.type)),
              doc: item.doc,
              type: item.type,
              caption: item.name,
              value: item.name,
          ...
          if (
            (forceEnableAceTextCompletor || ternCompletions.length === 0) &&
            ts.aceTextCompletor
          ) {
            if (debugCompletions) console.time("aceTextCompletor");
            var textCompletions = [];
            try {
              ts.aceTextCompletor.getCompletions(
                editor,
                session,
                pos,
                prefix,
                function(error, data) {
                  ...
                  var otherCompletionsContains = function(value, minLength) {
                    ...
                    for (var i = 0; i < otherCompletions.length; i++) {
                      if (
                        otherCompletions[i].value.toString().toLowerCase() ==
                        value
                      ) {
                        isDupe = true;
                        break;
          ...
          if (otherCompletions.length > 0) {
            ...
            for (var n = 0; n < otherCompletions.length; n++) {
              ...
              for (var i = 0; i < ternCompletions.length; i++) {
                if (
                  ternCompletions[i].value.toString() === b.value.toString()
                ) {
                  isDuplicate = true;
                  break;
                }
          ...
          if (debugCompletions)
            console.timeEnd("get and merge other completions");
          ...
          function popupSelectionChanged() {
            ...
            tooltip = makeTooltip(
              node.getBoundingClientRect().right + window.pageXOffset,
              node.getBoundingClientRect().top + window.pageYOffset,
              createInfoDataTip(data, true),
              editor
            );
    ...
    function showType(ts, editor, pos, calledFromCursorActivity) {
      if (calledFromCursorActivity) {
        //check if currently in call, if so, then exit
        if (
          editor.completer &&
        ...
        //run this check here if not from cursor as this is run in isOnFunctionCall() above if from cursor
      ...
      var cb = function(error, data, typeData) {
        ...
        if (ts.options.typeTip) {
          ...
          if (data.hasOwnProperty("type")) {
            ...
            if (
              data.type.toString().length > 1 &&
              data.type.toString().substr(0, 2) !== "fn"
            ) {
    ...
    function createInfoDataTip(data, includeType, activeArg) {
            ...
            if (!useDetailedArgHints) {
              ...
              if (children && children.length > 0) {
                ...
                for (var c = 0; c < children.length; c++) {
                  ...
                  if (c + 1 !== children.length && children.length > 1)
                    type += ", ";
                }
                type += "}";
              }
            ...
            if (activeParamChildren && activeParamChildren.length > 0) {
              for (var i = 0; i < activeParamChildren.length; i++) {
                ...
                typeStr +=
                  ...
                  cls +
                  "farg-current-name\">" +
                  getParamDetailedName(activeParamChildren[i]) +
                  ": </span>" +
                  activeParamChildren[i].description +
                  "</div>";
              }
            }
          }
      ...
      if (isNaN(parseInt(activeArg))) {
          ...
          var replaceParams = function(str, params) {
            ...
            for (var i = 0; i < params.length; i++) {
              ...
              if (params[i].parentName.trim() === "") {
                paramStr +=
                  " <span class=\"" + cls + "jsdoc-tag\">@param</span> ";
              } else {
                paramStr +=
                  "<span class=\"" +
                  cls +
          ...
          var highlightTypes = function(str) {
            ...
            try {
              ...
              while ((m = re.exec(str)) !== null) {
                ...
                str = str.replace(
                  m[0],
                  " <span class=\"" + cls + "type\">" + m[0].trim() + "</span> "
                );
              }
            } catch (ex) {
              showError(ts, editor, ex);
        ...
        if (data.origin) {
          tip.appendChild(
            elt("div", null, elt("em", null, "source: " + data.origin))
          );
        }
      }
      return tip;
        ...
        for (var col = thisRow.length; col >= 0; col--) {
          ...
          if (ch === "}" || ch === ")" || ch === "]") {
            ...
            if (depth > 0) {
              ...
              if (!upToParen.length) {
                if (debugFnCall)
                  console.log("not fn call because before parent is empty");
                break;
              }
              if (upToParen.substr(upToParen.length - 1) === " ") {
                if (debugFnCall)
                  console.log(
                    "not fn call because there is a space before paren"
                  );
                break;
              }
              ...
              if (
                wordBeforeFnName &&
                wordBeforeFnName.toLowerCase() === "function"
              ) {
                if (debugFnCall)
                  console.log(
                    "not fn call because this is a function declaration"
                  );
                break;
              }
              ...
              if (token) {
                if (
                  token.type.toString().indexOf("comment") !== -1 ||
                  token.type === "keyword" ||
                  token.type === "storage.type"
                ) {
                  if (debugFnCall)
                    console.log(
                      "existing because token is comment, keyword, or storage.type (`function`)"
                    );
                  break;
                }
              }
    ...
    function makeTooltip(
      ...
      if (closeOnCusorActivity === true) {
        if (!editor) {
          throw Error(
            "tern.makeTooltip called with closeOnCursorActivity=true but editor was not passed. Need to pass editor!"
          );
        }
    ...
    function jumpToDef(ts, editor) {
      function inner(varName) {
        ...
        ts.server.request(buildRequest(ts, doc, req, null, true), function(
          error,
          data
        ) {
          if (error) return showError(ts, editor, error);
      ...
      if (curDoc != doc) {
        if (ts.options.switchToDoc) {
          ...
          showError(
            ts,
            curDoc.doc,
            "Need to add editor.ternServer.options.switchToDoc to jump to another document"
          );
        }
        return;
      }
    ...
    function findContext(editor, data) {
      try {
        ...
        for (
          var cur = startLine + 1;
          cur < editor.session.getLength() && text.length < data.context.length;
          ++cur
        ) {
        ...
        console.log(
          "ext-tern.js findContext Error; (error is caused by a doc (string) being passed to this function instead of editor due to ghetto hack from adding VS refs... need to fix eventually. should only occur when jumping to def in separate file)",
          ex
        ); //,'\neditor:',editor,'\ndata:',data);
      }
      return data;
      //   console.log(
      //     new Error(
      //       "This part is not complete, need to implement using Ace's search functionality"
      //     )
      //   );
      ...
      //   else
      //     var end = Pos(
      //       nearest.line + (data.end.line - data.start.line),
      //       data.end.ch
      //     );
      //   return {
      //     start: nearest,
    ...
    function atInterestingExpression(editor) {
      ...
      return /\w/.test(
        editor.session
          .getLine(pos.line)
          .slice(Math.max(pos.ch - 1, 0), pos.ch + 1)
      );
    }
    ...
    function trackChange(ts, doc, change) {
      ...
      if (
        argHints &&
        argHints.doc == doc &&
        cmpPos(argHints.start, _change.to) <= 0
      ) {
    ...
    function loadExplicitVsRefs(ts, editor) {
      if (
        !editor.ternServer ||
        !editor.ternServer.enabledAtCurrentLocation(editor)
      ) {
        return;
      }
      var isBrowser =
      ...
      while ((m = re.exec(StringtoCheck)) != null) {
        ...
        var r = m[0].replace("\"", "");
        if (
          r.toLowerCase().indexOf("reference path") === -1 &&
          r.trim() !== "" &&
          r.toLowerCase().indexOf("/>") === -1
        ) {
          if (r.toLowerCase().indexOf("vsdoc") === -1) {
            //dont load vs doc files as they are visual studio xml junk
            refs.push(r);
          }
        }
      }
      ...
      var addFileDone = function(msg, isErr) {
        ...
        el.setAttribute(
          "style",
          "font-size:smaller; font-style:italic; color:" +
            (isErr ? "red" : "gray")
        );
        el.textContent = msg;
              ...
              if (xhr.readyState == 4) {
                if (xhr.status == 200) {
                  ...
                  if (xhr.status == 404) {
                    //not found
                    console.log(
                      "error adding web reference (not found): " + path,
                      xhr
                    );
                    addFileDone(
                      "error adding web reference (not found): " + path,
  ...
  function(require, exports, module) {
    ...
    var keyWordCompleter = {
      getCompletions: function(editor, session, pos, prefix, callback) {
        ...
        var completions = session.$mode.getCompletions(
          state,
          session,
          pos,
          prefix
      ...
      editor.completers.forEach(function(completer) {
        if (completer.identifierRegexps) {
          completer.identifierRegexps.forEach(function(identifierRegex) {
            if (!prefix && identifierRegex)
              prefix = util.retrievePrecedingIdentifier(
                line,
                pos.column,
                identifierRegex
              );
    ...
    Autocomplete.startCommand = {
      ...
      exec: function(editor, e) {
        ...
        editor.completers = [];
        if (editor.$enableSnippets) {
          //snippets are allowed with or without tern
    ...
    var onCursorChange_Tern = function(e, editor_getSession_selection) {
      ...
      debounceArgHints = setTimeout(function() {
        editor_for_OnCusorChange.ternServer.updateArgHints(
          editor_for_OnCusorChange
        );
      }, 10);
    };
    var onAfterExec_Tern = function(e, commandManager) {
      if (e.command.name === "insertstring" && e.args === ".") {
        if (
          e.editor.ternServer &&
          e.editor.ternServer.enabledAtCurrentLocation(e.editor)
        ) {
        ...
        set: function(val) {
          ...
          if (val) {
            ...
            createTernServer(function() {
              self.completers = completers.concat(aceTs);
              self.ternServer = aceTs;
              self.commands.addCommand(Autocomplete.startCommand);
              self
                .getSession()
                .selection.on("changeCursor", onCursorChange_Tern);
            ...
            self
              .getSession()
              .selection.off("changeCursor", onCursorChange_Tern);
...
(function() {
  ace.acequire(["ace/tern/tern"], function() {});
})();
